...
<template>
  <div
    ...
    :key="copyTooltip.id"
    class="pointer-events-none fixed -translate-1/2 transform animate-copy-tooltip-fade-in-out rounded-sm bg-intense-cherry-500 px-4 py-2 text-sm font-medium text-intense-cherry-50 shadow-md before:absolute before:-bottom-1.25 before:left-1/2 before:-translate-x-1/2 before:border-x-[5px] before:border-t-[5px] before:border-solid before:border-x-transparent before:border-t-intense-cherry-500 before:border-b-transparent before:content-['']"
    :style="{
